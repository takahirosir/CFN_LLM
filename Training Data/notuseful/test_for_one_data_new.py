...
task_list = TaskList(
    tasks=['T1', 'T2', 'T3', 'T4'],
    task_storage={'T1': 30, 'T2': 60, 'T3': 90, 'T4': 120},  # 添加任务需要的存储资源
    task_processing={'T1': 5, 'T2': 10, 'T3': 15, 'T4': 20},  # 添加任务需要的计算资源
    data_volumes={'T1': 50, 'T2': 100, 'T3': 150, 'T4': 200},  # 添加任务的数据量
    max_delays={'T1': 10, 'T2': 20, 'T3': 30, 'T4': 40}  # 添加任务允许的最大延迟
)
